...
## [0.3.1] - 2023-05-21
#### Added
* Tests support for Chocolatey v2.0.0 and higher
### Fixed
* Emits uninstalled package names with Chocolatey v2.0.0 and higher (uninstalled version information not available)
